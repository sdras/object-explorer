    ...
    state: {
      ...
      createProp: [
        {
          ...
          desc: `Adiciona a propriedade descrita pelo descritor a um objeto<br>
            <br>
            <strong>Nota importante para iniciantes!</strong> É mais comum usar pontos finais ou colchetes para criar uma nova propriedade num objeto ou modificar uma já existente.  Assim: <code>obj.a = 1</code> or <code>obj[a] = 1</code>. Mas tecnicamente isto não é um método existente nos objetos e por isto não está incluído`,
        ...
        },
        {
          ...
          desc: `Adiciona uma ou mais propriedades descritas pelo descritor a um objeto<br>
            <br>
            <strong>Nota importante para iniciantes!</strong> É mais comum usar pontos finais ou colchetes para criar uma nova propriedade num objeto ou modificar uma já existente.  Assim: <code>obj.a = 1</code> or <code>obj[a] = 1</code>. Mas tecnicamente isto não é um método existente nos objetos e por isto não esta incluído`,
      ...
      infoObj: [
        ...
        },
        {
          ...
          desc:
            'Compara duas referências e vê se ambas apontam para o mesmo objeto. Iguala todos os valores NaN (o que difere de ambos Abstract Equality Comparison e Strict Equality Comparison). Esta é um tanto estranha e a documentação da Mozilla é um pouco confusa. É mais util usar <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Equality_comparisons_and_sameness#When_to_use_Object.is_versus_triple_equals" target="_blank">três iguais <code>===</code></a> para verificar igualdade.',
          example: `let obj2 = {<br>
          <span>&nbsp;&nbsp;</span>a: 1,<br>
          <span>&nbsp;&nbsp;</span>b: 2,<br>
          <span>&nbsp;&nbsp;</span>c: 3<br>
        ...
        },
        {
          ...
          desc: 'Retorna um booleano indicando se o objeto ao qual este método for chamado está ou não na cadeia de protótipos do objeto especificado.',
      ...
      noChange: [
        ...
        },
        {
          ...
          desc: `Previne que se adicionem novas propriedades a um objeto. Você ainda pode apagar ou modificar as que já existem.`,
      ...
      createString: [
        ...
        },
        {
          ...
          desc: `O método <code>toLocaleString()</code> retorna a representação em texto localizado do objeto. Este método retornaa coisas diferentes em ocasiões diferentes. Por exemplo se você tive uma data guardada este método vai te retornar um formato de data diferente dependendo da sua localização.`,
        ...
        details: [
          {
            ...
            desc:
              'Retorna a descrição e caraterísticas da propriedade passada à função.',
        ...
        list: [
          {
            name: 'keys',
            shortDesc: `keys`,
            desc: `Retorna uma array com os nomes das keys que podem ser enumeradas.`,
          ...
          },
          {
            name: 'values',
            shortDesc: `valores`,
            desc: `Retorna uma array com os valores que podem ser enumerados.`,
      ...
      prototype: [
        ...
        },
        {
          ...
          desc: `Atenção: este método é muito lento. Usar com precaução ou substituir por <code>Object.create()</code>. Define o protótipo (o valor da propriedade interna [[Prototype]]).`,
        ...
        },
        {
          ...
          desc: `Retorna um booleano indicando se o objeto que é usado neste método faz parte da cadeia de protótipos do objeto especificado.`,
          example: `function Rect() {}<br>
          <br>
          var rect = new Rect();<br>
          <br>
